...
| #   | Test                        | Omschrijving                                                                         | Server                                | Front-end                       |
| --- | --------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------- | ------------------------------- | --- |
| 1.  | Inloggen met Microsoft      | Automatisch inloggen op Microsoft via applicatie                                     | -                                     | `$ npm run e2e-auth`            |
| 2.  | Aanmaken nieuw logboek      | Aanmaken nieuw logboek                                                               | -                                     | `$ npm run e2e-new-logbook`     |
| 3.  | Bekijken groepsoverzicht    | Bekijken van een groepsoverzicht + websocket implementatie i.c.m. studentenpagina's. | `$ node seeds/e2e/group-overview.js`  | `$ npm run e2e-group-overview`  |
| 4.  | Bekijken studentenlogboeken | Inzien van logboeken per student.                                                    | `$ node seeds/e2e/student-logbook.js` | `$ npm run e2e-student-logbook` |
| 5.  | Wijzigen studententoegang   | Wijzig het formulier waar de student toegang tot heeft.                              | `$ node seeds/e2e/student-access.js`  | `$ npm run e2e-student-access`  |
| 6.  | Studentpagina's             | Testen van het invullen van invoervelden en versturen van vragen.                    | -                                     | -                               |
| 7.  | Inloggen app via teams      | Inloggen via teams omgeving en rekenlogboek openen                                   | -                                     | `$ npm run e2e-teams-login`     |     |
