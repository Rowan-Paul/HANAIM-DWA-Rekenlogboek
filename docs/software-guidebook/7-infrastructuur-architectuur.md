...
Testen zullen worden uitgevoerd voordat het gemerged wordt met de develop branch. Dit testen gebeurt met behulp van het test framework [Jest](https://jestjs.io/). De testen zijn vooral voor de backend.
